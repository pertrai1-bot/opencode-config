...
- reviewing whether implementation matches an existing spec - use `spec-reviewer`
- generating implementation tasks from an existing PRD - use `implementation-task-planner`
...
After producing the PRD, stop. Do not generate implementation tasks unless the user asks or routing selects `implementation-task-planner` as a separate follow-on step. Do not edit product code.
