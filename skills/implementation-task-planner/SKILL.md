...
- creating the PRD itself - use `product-requirements-writer`
- reviewing code against a spec - use `spec-reviewer`
...
If requirements are too vague to plan safely, ask a concise clarifying question or route back to `product-requirements-writer`.
